...
namespace ClinicaWeb.Controllers
{
    ...
    public class MunicipiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre_mun,DepartamentoId")] Municipio municipio)
        {
            ...
            ViewBag.DepartamentoId = new SelectList(db.Departamentos, "Id", "Nombre_dpto", municipio.DepartamentoId);
            return View(municipio);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre_mun,DepartamentoId")] Municipio municipio)
        {
            if (ModelState.IsValid)
            {
