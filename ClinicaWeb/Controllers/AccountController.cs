...
namespace ClinicaWeb.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string nombre, int edad, string cel, string dir, int mun, int sex)
        {
            ViewBag.MunicipioId = new SelectList(db.Municipios, "Id", "Nombre_mun");
            ViewBag.SexoId = new SelectList(db.Sexos, "Id", "TipoSexo");
            ...
            if (ModelState.IsValid)
            {
                ...
                pac.Nombre_pac = nombre;
                pac.Correo = model.Email;
                pac.Edad = edad;
                pac.Celular = cel;
                pac.Direccion = dir;
                pac.MunicipioId = mun;
        ...
        {
            return Json(new SelectList(db.Municipios.Where(x => x.DepartamentoId == id), "Id", "Nombre_mun"), JsonRequestBehavior.AllowGet);
        }
    }
}